...
***************************************************************************** */
    ...
    window.onload = function() {
        ...
        function blackBGSize() {
            if (!isMobile.any()) {
                const blackBackground = document.querySelectorAll(".item-product__actions");
                const productImage = document.querySelector(".item-product__image img");
                for (let i = 0; i < blackBackground.length; i++) {
                    const productImageHeight = productImage.offsetHeight;
                    blackBackground[i].style.height = `${productImageHeight}px`;
                }
            }
        }
        blackBGSize();
        function documentActions(e) {
            ...
            if (isMobile.any()) {
                ...
                if (!targetElement.classList.contains("menu__arrow") && document.querySelectorAll("._hover").length > 0) for (let i = 0; i < document.querySelectorAll("._hover").length; i++) document.querySelectorAll("._hover")[i].classList.remove("_hover");
            }
            if (targetElement.classList.contains("search-form__icon")) document.querySelector(".search-form").classList.toggle("_active"); else if (!targetElement.closest(".search-form") && document.querySelectorAll("._active").length > 0) for (let i = 0; i < document.querySelectorAll("._active").length; i++) document.querySelectorAll("._active")[i].classList.remove("_active");
            ...
            if (targetElement.classList.contains("cart-header__icon") || targetElement.closest(".cart-header__icon")) {
                if (document.querySelector(".cart-list").children.length > 0) document.querySelector(".cart-header").classList.toggle("cart-header__active");
                e.preventDefault();
        ...
        async function getProducts(button) {
            if (!button.classList.contains("_hold")) {
                ...
                const file = "files/files/products.json";
        ...
        function loadProducts(data) {
            ...
            data.products.forEach((item => {
                ...
                let productTemplateActions = `\n         <div class="item-product__actions actions-product">\n            <div class="actions-product__body">\n               <a class="actions-product__button btn btn_white">Add to cart</a>\n               <a href="${productShareUrl}" class="actions-product__link _icon-share">Share</a>\n               <a href="${productLikeUrl}" class="actions-product__link _icon-favorite">Like</a>\n            </div>\n         </div>\n      `;
        ...
        function addToCart(productButton, productId) {
            if (!productButton.classList.contains("._hold")) {
                ...
                productImageFly.style.cssText = "left: " + cartFlyLeft + "px; " + "top: " + cartFlyTop + "px; " + "opacity: 0; " + "height: 0px; " + "width: 0px; ";
        ...
        function upDateCart(productButton, productId, productAdd = true) {
            ...
            if (productAdd) {
                ...
                if (!cartProduct) {
                    ...
                    const cartProductContante = `\n            <a class="cart-list__image -ibg">${cartProductImage}</a>\n            <div class="cart-list__body">\n               <a href="" class="cart-list__title">${cartProductTitle}</a>\n               <div class="cart-list__quantity">Quantity: <span>1</span></div>\n               <a class="cart-list__delete">Delete</a>\n            </div>\n            `;
                    cartList.insertAdjacentHTML("beforeend", `<li data-cart-pid = "${productId}" class="cart-list__item"> ${cartProductContante}</li>`);
                } else {
        ...
        const funtinure = document.querySelector(".furniture__body");
        if (funtinure && !isMobile.any()) {
            const funtinureItems = document.querySelector(".furniture__items");
            const funtinureColumn = document.querySelectorAll(".furniture__column");
            const speed = funtinure.dataset.speed;
            let positionX = 0;
            let CordXprocent = 0;
            function setMouseGalleryStyle() {
                let funtinureItemsWidth = 0;
                funtinureColumn.forEach((element => {
                    funtinureItemsWidth += element.offsetWidth;
                }));
                const funtinureDifferent = funtinureItemsWidth - funtinure.offsetWidth;
                const distX = Math.floor(CordXprocent - positionX);
                const maxDist = funtinureDifferent / 90;
                positionX += distX * speed;
                if (positionX < -maxDist) positionX = -maxDist; else if (positionX > maxDist) positionX = maxDist;
                let position = funtinureDifferent / 200 * positionX;
                funtinureItems.style.cssText = `transform: translate3d(${-position}px,0px,0px);`;
                if (Math.abs(distX) > 0) requestAnimationFrame(setMouseGalleryStyle); else funtinure.classList.remove("_init");
            }
            funtinure.addEventListener("mousemove", (function(e) {
                const funtinureWidth = funtinure.offsetWidth;
                const coordX = e.pageX - funtinure.offsetLeft - funtinureWidth / 2;
                CordXprocent = coordX / funtinureWidth * 200;
                if (!funtinure.classList.contains("_init")) {
                    requestAnimationFrame(setMouseGalleryStyle);
                    funtinure.classList.add("_init");
                }
            }));
        }
    };
